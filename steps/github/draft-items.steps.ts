...
When('I create a draft issue with title {string} via the API', async ({ projectsAPI, sandbox, dataManager }, title: string) => {
...
When('I create a full issue with the same title via the API', async ({ githubAPI, projectsAPI, sandbox, dataManager }) => {
